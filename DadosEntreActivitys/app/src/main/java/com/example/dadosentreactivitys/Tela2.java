...
public class Tela2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textNome = findViewById(R.id.nometela2);
        textEmail = findViewById(R.id.emailtela2);
        aceitar = findViewById(R.id.buttontela2);
        rejeitar = findViewById(R.id.buttontela22);
